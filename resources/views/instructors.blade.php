...
<div class="container3">
  ...
  <center><h4><b>DEPARTMENT OF ELECTRONICS AND TELECOMMUNICATIONS ENGINEERING</b></h4>
...
<table class="hover table table-striped table-bordered" id="myTable1">
  ...
  <div class="form-group row">
    <label for="course{{$instructors->id}}"  class="col-sm-3 col-form-label"><strong>Course ID: </strong></label>
    <div class="col-sm-9">
    <input type="text" class="form-control" id="course{{$instructors->id}}" name="course" value="{{$instructors->course}}" autocomplete="off" readonly="">
  </div>
  </div>
  <br>
