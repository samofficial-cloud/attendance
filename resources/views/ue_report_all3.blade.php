...
<div class="container">
  ...
  @if(count($all_test)>0)
        ...
        <h5 class="note">Course: {{$fullCourse}} </h5>
                <b><p class="note">UE Attendance Report Showing Only Students Who Are Present</p></b>
        </legend> </div>
  @else
...
<div class="col-xs-6">
  ...
  @endif
      ...
      <form action="{{route('ue_report_all3pdf')}}" class="form-container form-horizontal" method="get">
                 {{csrf_field()}}
