...
<div class="container">
  <div class="row">
    ...
    <div class="flex_container">
      ...
      <div style="flex-grow: 2" class="card shadow-sm p-4 mb-4 bg-white  flex_container_div">
        ...
        <div class="flex_container_inside">
          ...
          <div class="photo"><center><img src="{{ asset('img/report.png') }}" width="40%"></img></center></div>
      ...
      <div style="flex-grow: 2" class="card shadow-sm p-4 mb-4 bg-white  flex_container_div">
        ...
        <div class="flex_container_inside">
          ...
          <div class="heading"><h3>OTHER INFORMATION</h3></div>
          <div class="content">
            <p>Through this system you can get various information such as list of students for a particular degree program, list of courses to be taken for a particular degree rogram and year of study, list of teaching staff and so much more.  </p>

          </div>
          
          <br>

          <div class="photo"><center><img src="{{ asset('img/info_icon.jpg') }}" width="40%" class="center"></img></center></div>
