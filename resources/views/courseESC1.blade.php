...
<div class="modal fade" id="newcourse" role="dialog">
  ...
  {{csrf_field()}}
    ...
    <div class="col-sm-7">
    <input type="text" class="form-control" id="program" name="program" value="ESC1" readonly>
  </div>
  </div>
  ...
  <br>
    ...
    <table class="table table-striped table-bordered" style="width: 120%" id="myTable">
...
<center><a class="btn btn-sm btn-success" href="{{route('ESC1pdf')}}">PRINT</a></center>
